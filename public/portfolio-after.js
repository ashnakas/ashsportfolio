...
work.innerHTML = `<header><span>FROM THE OBSERVATORY / SELECTED WORK</span><a href="mailto:akasireddy3@gatech.edu">LET’S TALK ↗</a></header>
<div class="portfolio-work-title"><h2>A closer<br><em>look.</em></h2><p>Exploring the space between human needs,<br>emerging technology, and thoughtful design.</p></div>
...
</div><footer><a href="#">↑ Back to the clouds</a><span>Ashna Kasireddy · Product design</span></footer>`;
